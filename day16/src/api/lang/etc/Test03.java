...
public class Test03 {
	...
	public static void main(String[] args) {
		...
		// - System.in -> 표준 입력 스트림(통로) ->잘 안 씀. Scanner를 씀.
		
		//스트림마다 용도가 정해져 있고, 혼합하여 사용하는 것은 금지!
		System.out.println("Hello");
		System.err.println("Hello"); //-> 빨간색 글씨로 나옴. error니까.
		
		//메소드
		
		//[1] 시간 측정 메소드
		// = 프로그래밍에서는 '기준시각'이라는 것이 존재
		// = 1970년 1월 1일 0시 0분 0초 (*기준시각)
		...
		if(osName.matches("^Windows\\s(3\\.1|XP|7|8|10|11)$")) {	//windows 정규표현식 
		System.out.println("윈도우 사용중이시네요!");
		}
		
		System.out.println(prop.getProperty("java.version")); //자바버전
		...
		// = 오류 상태 번호는 정하기 나름 (구글 -> 이클립스 오류 코드 검색)
