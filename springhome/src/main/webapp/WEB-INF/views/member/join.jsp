<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    아이디* <input type="text" name="memberId" reqired><br><br>
    비밀번호* <input type="password" name="memberPw" reqired><br><br>
    닉네임* <input type="text" name="memberNickname" reqired><br><br>
